  ...
  context "if user is admin" do
    ...
    describe "POST #create" do
      it "should create a slider" do
        post :create,params:{home_slider: { title: "this call title",sub_title:"this called subtitle", image:Rack::Test::UploadedFile.new(Rails.root.join('spec','support','images', 'top_logo.png'), 'image/png')}}
    ...
    describe "PUT #update" do
      it "should update a slider" do
        homeSlider = create(:homeSlider)
        put :update,params:{id: homeSlider.id,home_slider: { title: "title1",sub_title:"subtitle1", image:Rack::Test::UploadedFile.new(Rails.root.join('spec','support','images', 'top_logo.png'), 'image/png')}}
        expect(response).to redirect_to(admin_home_sliders_path)
      end
    end
