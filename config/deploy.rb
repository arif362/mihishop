...
set :application, 'mihishop'
set :repo_url, 'git@bitbucket.org:arif362/mihishop.git'
set :user, 'ubuntu'
...
set :rvm_ruby, '2.3.1'
set :ssh_options, {
                    :keys => '/home/arif/.ssh/mihishop_production.pem'
                }
# Default value for :format is :prett
# set :format, :pretty
